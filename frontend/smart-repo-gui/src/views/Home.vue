    ...
    <v-container :fluid="true" class>
      ...
      >
        ...
        <v-list subheader>
          ...
          <v-list-item> Uploaded by: {{ drawerItem.uploaded_by }} </v-list-item>
          <v-list-item> Type: {{ drawerItem.type }} </v-list-item>
          <v-list-item> Size: {{ drawerItem.size }} </v-list-item>
        </v-list>
        <v-divider />
